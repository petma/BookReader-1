 ...
 * @date 16/9/3.
 */
class CommentListAdapter(context: Context) : RecyclerArrayAdapter<CommentList.CommentsBean>(context) {

    override fun OnCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        return object : BaseViewHolder<CommentList.CommentsBean>(parent, R.layout.item_comment_list) {
            override fun setData(item: CommentList.CommentsBean) {
