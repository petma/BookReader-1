 ...
 * 书评区
 */
class BookReviewActivity : BaseCommuniteActivity() {

    @Bind(R.id.slOverall)
    internal var slOverall: SelectionLayout? = null

    override val layoutId: Int
        get() = R.layout.activity_community_book_review
    ...
    companion object {
        ...
        fun startActivity(context: Context) {
            context.startActivity(Intent(context, BookReviewActivity::class.java))
        }
    }
}
