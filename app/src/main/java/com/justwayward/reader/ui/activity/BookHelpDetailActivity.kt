 ...
 * 书荒互助区详情
 */
class BookHelpDetailActivity : BaseRVActivity<CommentList.CommentsBean>(), BookHelpDetailContract.View, OnRvItemClickListener<CommentList.CommentsBean> {
    ...
    @Inject
    internal var mPresenter: BookHelpDetailPresenter? = null
    ...
    override fun configViews() {
        ...
        mAdapter!!.addHeader(object : RecyclerArrayAdapter.ItemView {
            override fun onCreateView(parent: ViewGroup): View {
                return LayoutInflater.from(this@BookHelpDetailActivity).inflate(R.layout.header_view_book_discussion_detail, parent, false)
            }
    ...
    override fun showBookHelpDetail(data: BookHelp) {
        ...
        headerViewHolder!!.tvCommentCount!!.text = String.format(mContext.getString(R.string.comment_comment_count), data.help!!.commentCount)
    }
    ...
    override fun showBookHelpComments(list: CommentList) {
    ...
    companion object {
        ...
        fun startActivity(context: Context, id: String) {
            context.startActivity(Intent(context, BookHelpDetailActivity::class.java)
