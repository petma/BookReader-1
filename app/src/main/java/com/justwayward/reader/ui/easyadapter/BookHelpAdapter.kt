 ...
 * @date 16/9/3.
 */
class BookHelpAdapter(context: Context) : RecyclerArrayAdapter<BookHelpList.HelpsBean>(context) {

    override fun OnCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        return object : BaseViewHolder<BookHelpList.HelpsBean>(parent, R.layout.item_community_book_help_list) {
            override fun setData(item: BookHelpList.HelpsBean) {
