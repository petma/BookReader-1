 ...
 * @date 16/9/3.
 */
class BookDetailReviewAdapter(context: Context) : RecyclerArrayAdapter<HotReview.Reviews>(context) {

    override fun OnCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        return object : BaseViewHolder<HotReview.Reviews>(parent, R.layout.item_book_detai_hot_review_list) {
            override fun setData(item: HotReview.Reviews) {
