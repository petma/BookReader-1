 ...
 * @date 16/9/3
 */
interface BookReviewDetailContract {
    ...
    interface Presenter : BaseContract.BasePresenter<View> {
        ...
        fun getBookReviewDetail(id: String)

        fun getBestComments(bookReviewId: String)

        fun getBookReviewComments(bookReviewId: String, start: Int, limit: Int)
