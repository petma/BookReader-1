 ...
 * @date 2016/10/18.
 */
abstract class BaseReadView(context: Context, protected var bookId: String, chaptersList: List<BookMixAToc.mixToc.Chapters>,
    ...
    init {
        ...
        mScreenWidth = ScreenUtils.screenWidth
