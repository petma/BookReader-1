...
class PageWidget(context: Context, bookId: String,
    ...
    internal var mBackShadowColors: IntArray// 背面颜色组
    internal var mFrontShadowColors: IntArray// 前面颜色组

    internal var mBackShadowDrawableLR: GradientDrawable // 有阴影的GradientDrawable
    internal var mBackShadowDrawableRL: GradientDrawable
    internal var mFolderShadowDrawableLR: GradientDrawable
    internal var mFolderShadowDrawableRL: GradientDrawable

    internal var mFrontShadowDrawableHBT: GradientDrawable
    internal var mFrontShadowDrawableHTB: GradientDrawable
    internal var mFrontShadowDrawableVLR: GradientDrawable
    internal var mFrontShadowDrawableVRL: GradientDrawable
